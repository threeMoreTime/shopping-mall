	...
	<view class="bg">
		<view class="tabBox">
			<view class="tabBoxs">
				...
				<view class="titleText">黄金兑换</view>
			</view>
		</view>
		<view class="context">
			<view class="cart">
				<view class="exchangeInfo">
					<text>兑换券</text>
					<text style="font-size: 40rpx;font-weight: 800;padding-top: 10rpx;">17213.37</text>
				</view>
			</view>
			<view class="cart">
				<view class="plantTrees">
					<text>兑换种树积分</text>
					<u-input v-model="countNum" type="number" :border="false" input-align="right" />
				</view>
				<view class="exchange">
					<text>需要兑换券</text>
					<text>0</text>
